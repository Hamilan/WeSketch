...
/**
 * Después de realizar pruebas con esta clase deben borrarse 
 * las líneas que están en comentario
 * @author Hamilan
 */
...
ControllerListener {
	...
	public AVTransmitter( int data_port) {
	 ...
	 * filename should be http://javasound:8000 for CVEGUIS
	 */
	public synchronized String start( String filename, Vector<Target> targets) {
		String result;
	 ...
	 */
	private String createTransmitter( Vector<Target> targets) {
